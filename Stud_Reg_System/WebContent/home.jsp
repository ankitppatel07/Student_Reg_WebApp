	...
	<div class="container">
		<div class="row">
			<div class="card col-md-4 form-group">
				...
				<form method="get" action="Stud_Reg_Servlet">
					<p class="mb-0 text-dark">Enter Classid to find TA:</p>
				...
				<form method="get" action="Stud_Reg_Servlet">
					...
					<input type="text" class="form-control form-control-sm" name="b_no"
						maxlength="4">
				...
				<form method="get" action="Stud_Reg_Servlet">
					...
					<input type="text" class="form-control form-control-sm"
						name="classid" maxlength="5"> <br>
					<button type="button" class="btn btn-primary" name="call_value"
